...
int HDMITX_SearchVICIndex( ULONG PCLK, unsigned short HTotal, unsigned short VTotal, BYTE ScanMode )
{
...
void HDMITX_MonitorInputVideoChange()
{
    ...
    static unsigned short prevHTotal = 0 ;
    static unsigned short prevVTotal = 0 ;
...
void HDMITX_ChangeDisplayOption(HDMI_Video_Type OutputVideoTiming, HDMI_OutputColorMode OutputColorMode)
{
   	...
   	switch(OutputVideoTiming)
	{
		case HDMI_640x480p60:
			VIC = 1 ;
			VideoPixelClock = 25000000 ;  //6121
		
			pixelrep = 0 ;
			aspec = HDMI_4x3 ;
			Colorimetry = HDMI_ITU601 ;
			printk("HDMI_640x480p60 ..25M... \n");
			break ;
