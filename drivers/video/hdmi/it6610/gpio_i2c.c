...
//#define HDMI_I2C_SCL          (32*3+7)
//#define HDMI_I2C_SDL          (32*3+6)
//#else
////#define HDMI_I2C_SCL          (GPD31)
////#define HDMI_I2C_SDL          (GPD30)
//#define HDMI_I2C_SCL          (32*3+31)
//#define HDMI_I2C_SDL          (32*3+30)
//#endif
//#define HDMI_I2C_SCL          (32 * 4 + 31) /*PE31*/
//#define HDMI_I2C_SDL          (32 * 4 + 30) /*PE30*/
...
{
	disable_i2c_normal();
	CFG_WRITE(HDMI_I2C_SCL);
	CFG_WRITE(HDMI_I2C_SDL);
	mdelay(10);
}
...
{
	enable_i2c_normal();
//	CFG_READ(HDMI_I2C_SCL);
//	CFG_READ(HDMI_I2C_SDL);
}
...
//      SCL_PORT = bit_value;
     	if(bit_value)
		MAKE_HIGH(HDMI_I2C_SCL);
	else
		MAKE_LOW(HDMI_I2C_SCL);
	WAIT_STAB;
}
...
//	SDA_PORT = bit_value;
	if(bit_value)
		MAKE_HIGH(HDMI_I2C_SDL);
	else
		MAKE_LOW(HDMI_I2C_SDL);
	WAIT_STAB;
}
