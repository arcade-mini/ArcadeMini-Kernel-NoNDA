...
//use customer-9 4.3lcd board to connect pc
#define GPIO_USB_DETE       GPD07 //GPA06
...
do {								\
	...
	__tcu_set_full_data(LCD_PWM_CHN, JZ_EXTAL / 15000);	\
	__tcu_set_half_data(LCD_PWM_CHN, JZ_EXTAL / 15000 * n / LCD_PWM_FULL); \
...
#define UMIDO_KEY_LEFT      GPD00

#define UMIDO_KEY_A         GPB16//GPD22 
#define UMIDO_KEY_B         GPD23
#define UMIDO_KEY_X         GPB15 
#define UMIDO_KEY_Y         GPD22//GPB16 

#define UMIDO_KEYL          GPB23
#define UMIDO_KEYR          GPD24

#define UMIDO_KEY_SELECT    GPD17
#define UMIDO_KEY_START     GPD18

//#define UMIDO_KEY_VOL_UP    GPD25
//#define UMIDO_KEY_VOL_DOWN  GPD21
