...
struct mmc_partition_info lepus_partitions[] = {
	...
	[5] = {"rootfs",12*1024*1024,250*1024*1024,1}, //250MB
	[6] = {"data",262*1024*1024,90*1024*1024,1},  //90MB app
	[7] = {"cache",352*1024*1024,30*1024*1024,1}, //30MB cfg
	[8] = {"test_0",382*1024*1024,3355*1024*1024UL,0},//4G is 3737
#else
